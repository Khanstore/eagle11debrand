...
.. code-block:: console
    ...
    $ ./eagle-exe scaffold Academy my-modules
...
* start the Odoo server
  ...
  .. code-block:: console
      ...
      $ ./eagle-exe --addons-path addons,my-modules
...
.. tip::
    ...
    the same time<eagle-exe -u>`:

    .. code-block:: console

        $ eagle-exe --addons-path addons,my-modules -d academy -u academy
