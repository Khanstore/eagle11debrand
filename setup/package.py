...
class KVMWinTestExe(KVM):
    def run(self):
        ...
        self.ssh('/cygdrive/c/"Program Files"/"Odoo {sv}"/python/python.exe \'c:\\Program Files\\Odoo {sv}\\server\\eagle-exe\' -d mycompany -i base --stop-after-init'.format(sv=setupversion))
